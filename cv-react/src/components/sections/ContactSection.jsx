...
const ContactSection = () => {
    ...
    return (
        <section id="contact" className="py-24 md:py-32 bg-gradient-to-b from-sand-50 to-earth-100">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div
                    ref={ref}
                    className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                        }`}
                >
                    {contactInfo.map((contact, index) => (
                        ...
                        >
                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-sage-100 to-terra-100 text-sage-600 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:from-sage-500 group-hover:to-terra-500 group-hover:text-white transition-all duration-500">
